...
class ActorsList (generic.ListView):
    template_name = 'distracted/actorsList.html'
...
class ActorDetail (generic.DetailView):
    model = Actor
    template_name = 'distracted/actorDetail.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['roles'] = Roles.objects.filter (actor = actor).order_by("sort_order", "name");
        return context
